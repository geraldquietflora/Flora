...
st.set_config_page(page_title="Flora - Identificador de Plantas", layout="centered")
...
# --- OPCIONES DE ENTRADA ---
# Usamos columnas para que elijas cómo quieres ingresar la imagen
opcion = st.radio("Selecciona fuente de imagen:", ["Cámara", "Subir Archivo"], horizontal=True)

uploaded_file = None

if opcion == "Cámara":
    # Este componente activa la cámara del celular o laptop
    uploaded_file = st.camera_input("Toma una foto de la planta")
else:
    # Este es el que ya tenías para archivos guardados
...
if uploaded_file is not None:
    ...
    # Si es archivo subido, mostramos vista previa (camera_input ya la muestra)
            ...
            try:
                response = client.models.generate_content(
                    ...
                    contents=[
                        ...
                        "familia, hábitat y si es nativa de la región neotropical.",
                        image
                    ]
                )
